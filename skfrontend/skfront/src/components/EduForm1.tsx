                ...
                <form className="bg-white shadow-xl shadow-black rounded-lg p-8">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                        <div>
                            ...
                            <input type="text" id="educatorName" name="educatorName" className="mt-1 block w-full h-12 rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 text-lg" placeholder="name" />
                        </div>
                        <div>
