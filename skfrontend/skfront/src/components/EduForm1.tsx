...
const EduForm1 = () => {
  ...
  return (
    <div className="min-h-screen eduform1-page py-12 px-4 sm:px-6 lg:px-8 ">
      <div className="max-w-7xl mx-auto">
        <form className="bg-white shadow-xl shadow-black rounded-lg p-8">
        <h2 className="text-5xl font-extrabold text-gray-900 text-center mb-8">Basic Info</h2>
            <span className='text-red-600'>* Field is required and cannot be empty</span>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="flex space-x-4">
              ...
              <div className="w-3/4">
                <label htmlFor="mobile" className="block text-lg font-medium text-gray-700 mb-2">Mobile (This is only used by OLL)</label>
