                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    type="file" id="resume" name="resume" className="mt-1 block w-full h-12 text-lg text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-lg file:font-semibold file:bg-indigo-50 file:text-indigo-700 hover:file:bg-indigo-100" />
                            </div>
                            <div className="flex space-x-4">
                                ...
                                <div className="w-3/4">
                                    ...
                                    <input
                                        ...
                                        type="tel" id="mobile" name="mobile" className="mt-1 block w-full h-12 rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 text-lg" placeholder="7428730894" />
                                </div>
                            </div>
                            <div>
