                ...
                <div className="text-content text-center md:text-left md:w-1/2 mb-8 md:mb-0">
                    ...
                    <div className="mt-6 flex flex-wrap justify-center md:justify-start">
                        ...
                        <button
                            ...
                            className="bg-black text-white font-bold py-2 px-6 rounded-full mr-2 mb-2 transition duration-300 hover:bg-gray-800">
                            School
                        </button>
                        <button
                            onClick={() => navigate("/educator")}
                            className="bg-gray-400 text-black font-bold py-2 px-6 rounded-full mr-2 mb-2 transition duration-300 hover:bg-gray-500">
                            Educator
                        </button>
                        <button
                            onClick={() => navigate("/student")}
                            className="bg-red-600 text-white font-bold py-2 px-6 rounded-full mb-2 transition duration-300 hover:bg-red-700">
                            Learner
                        </button>
                    </div>
                </div>
