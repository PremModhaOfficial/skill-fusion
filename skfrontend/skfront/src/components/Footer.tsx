        ...
        <footer className="footer px-14">
            <div className="container mx-auto px-4">
                ...
                <div>
                    ...
                    <li><a href="#" className=" transition-colors"><i className="fas fa-circle-info mr-2"></i>Contact Us</a></li>
                ...
                <div>
                    ...
                    <ul>
                    <li><a href="#" className=" transition-colors"><i className="fas fa-circle-info mr-2"></i>Explore All Class</a></li>
