        ...
        <div className="relative group">
          ...
          <div id="dropdown"
            ...
            <ul className="py-2 font-sans font-semibold text-sm">
              ...
              <li className="px-4 py-1 hover:bg-gray-100 flex justify-between"> Coding and Technology</li>
              <li className="px-4 py-1 hover:bg-gray-100 flex justify-between">Digital Arts</li>
              <li className="px-4 py-1 hover:bg-gray-100 flex justify-between">English</li>
              <li className="px-4 py-1 hover:bg-gray-100 flex justify-between">Life Skills</li>
              <li className="px-4 py-1 hover:bg-gray-100 flex justify-between">Maths & Science</li>
              <li className="px-4 py-1 hover:bg-gray-100 flex justify-between">Performing Arts</li>
              <li className="px-4 py-1 hover:bg-gray-100 flex justify-between">World Languages</li>
            </ul>
          </div>
        </div>
